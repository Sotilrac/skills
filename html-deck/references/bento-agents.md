> Snapshot of https://bento.page/agents.md (bento/slides 1.0.18, September 2026), bundled so the skill works offline. The live page is authoritative; refresh with `curl -fsSL https://bento.page/agents.md -o references/bento-agents.md` when the app version moves.

# bento/slides — for AI agents

**Guide version `1.0.18`** · document format `bento/slides` (v1). This
